# case-code-review 기여 가이드

case-code-review에 기여해 주셔서 감사합니다. 오타 수정, bug report, 새 기능 구현 등 모든 기여는 프로젝트에 도움이 됩니다.
...
- **Feature 제안**: 개선 아이디어가 있다면 [GitHub Discussions](https://github.com/qiankunli/case-code-review/discussions/categories/ideas)에서 논의를 시작하거나 [Feature Request](https://github.com/qiankunli/case-code-review/issues/new?template=feature_request.yml) issue를 열 수 있습니다.
- **문서 개선**: 오타 수정, 설명 보완, 예시 추가를 환영합니다. 문서 문제를 보고하려면 [Documentation Issue](https://github.com/qiankunli/case-code-review/issues/new?template=docs_report.yml)를 열어 주세요.
...
문서는 case-code-review의 중요한 일부입니다. README, inline code comment, configuration example, 사용자에게 노출되는 모든 text의 개선을 환영합니다.
...
1. 문제를 발견했지만 직접 수정할 계획이 없다면 [Documentation Issue](https://github.com/qiankunli/case-code-review/issues/new?template=docs_report.yml)를 열어 주세요.
...
모든 contributor는 Open Source Contributor License Agreement에 서명해야 합니다. 이는 프로젝트가 license terms에 따라 배포될 수 있도록 하기 위한 절차입니다.
...
- [`good first issue`](https://github.com/qiankunli/case-code-review/labels/good%20first%20issue): 시작하기 좋은 작고 범위가 명확한 task
- [`help wanted`](https://github.com/qiankunli/case-code-review/labels/help%20wanted): community help를 환영하는 issue
...
- **Feature Suggestions**: [GitHub Discussions (Ideas)](https://github.com/qiankunli/case-code-review/discussions/categories/ideas) 또는 [Feature Request Issue](https://github.com/qiankunli/case-code-review/issues/new?template=feature_request.yml)
- **Questions & Help**: case-code-review 사용과 관련한 질문은 [GitHub Discussions](https://github.com/qiankunli/case-code-review/discussions)에 올릴 수 있습니다.

## License

case-code-review에 기여하면 해당 기여가 [Apache License 2.0](LICENSE)에 따라 license되는 것에 동의하는 것입니다.
