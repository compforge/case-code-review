# Участие в разработке case-code-review

Спасибо за интерес к развитию case-code-review! Важен любой вклад — будь то исправленная опечатка, сообщение о баге или новая функциональность.
...
- **Предлагайте улучшения** — есть идея? Начните обсуждение в [GitHub Discussions](https://github.com/qiankunli/case-code-review/discussions/categories/ideas) или заведите issue [Feature Request](https://github.com/qiankunli/case-code-review/issues/new?template=feature_request.yml).
- **Улучшайте документацию** — исправляйте опечатки, проясняйте формулировки, добавляйте примеры. Чтобы сообщить о проблеме, можно также завести [Documentation Issue](https://github.com/qiankunli/case-code-review/issues/new?template=docs_report.yml).
...
```
├── cmd/casecodereview/   # Точка входа CLI
├── internal/
...
Документация — важнейшая часть case-code-review. Мы приветствуем улучшения README-файлов, комментариев в коде, примеров конфигурации и любых текстов, обращённых к пользователю.
...
1. Если вы заметили проблему, но не планируете исправлять её сами, заведите [Documentation Issue](https://github.com/qiankunli/case-code-review/issues/new?template=docs_report.yml).
...
1. Версию case-code-review (`ccr version`)
2. ОС и архитектуру
...
Прежде чем мы сможем принять ваш вклад, необходимо подписать Open Source Contributor License Agreement. Это гарантирует, что проект может распространяться на условиях своей лицензии.
...
- [`good first issue`](https://github.com/qiankunli/case-code-review/labels/good%20first%20issue) — небольшие, хорошо очерченные задачи, идеальные для старта.
- [`help wanted`](https://github.com/qiankunli/case-code-review/labels/help%20wanted) — задачи, где мы будем рады помощи сообщества.
...
- **Сообщения о багах** — [GitHub Issues](https://github.com/qiankunli/case-code-review/issues)
- **Предложения функциональности** — [GitHub Discussions (Ideas)](https://github.com/qiankunli/case-code-review/discussions/categories/ideas) или issue [Feature Request](https://github.com/qiankunli/case-code-review/issues/new?template=feature_request.yml)
- **Вопросы и помощь** — если у вас есть вопросы об использовании case-code-review, задавайте их в [GitHub Discussions](https://github.com/qiankunli/case-code-review/discussions)

## Лицензия

Внося вклад в case-code-review, вы соглашаетесь с тем, что ваш вклад будет лицензирован на условиях [Apache License 2.0](LICENSE).
