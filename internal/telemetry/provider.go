...
var serviceName = "case-code-review"
...
func Init(ctx context.Context) bool {
	...
	if err != nil {
		fmt.Fprintf(console.Err(), "[ccr] WARNING: failed to create OTel resource: %v\n", err)
...
// ContentLogging returns true when content logging is enabled via CCR_CONTENT_LOGGING.
