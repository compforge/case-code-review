// Package source acquires Runner inputs from git.
package source
...
func ParseDiffText(ctx context.Context, diffText string, repoDir string, ref string, runner *gitcmd.Runner) ([]change.Change, error) {
...
func finalizeDiff(ctx context.Context, d *change.Change, repoDir string, ref string, runner *gitcmd.Runner) {
