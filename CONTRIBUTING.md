# Contributing to case-code-review

Thank you for your interest in contributing to case-code-review! Every contribution matters — whether it's fixing a typo, reporting a bug, or implementing a new feature.
...
- **Suggest features** — Have an idea for improvement? You can start a conversation in [GitHub Discussions](https://github.com/qiankunli/case-code-review/discussions/categories/ideas) or open a [Feature Request](https://github.com/qiankunli/case-code-review/issues/new?template=feature_request.yml) issue.
- **Improve documentation** — Fix typos, clarify explanations, or add examples. You can also open a [Documentation Issue](https://github.com/qiankunli/case-code-review/issues/new?template=docs_report.yml) to report problems.
...
# 2. Clone your fork
git clone https://github.com/<your-username>/case-code-review.git
cd case-code-review

# 3. Add upstream remote (for syncing updates from the main repo)
git remote add upstream https://github.com/qiankunli/case-code-review.git
...
```
├── cmd/casecodereview/   # CLI entry point
├── internal/
...
│   ├── tool/             # Built-in tools (read_files, search_code, etc.)
...
Documentation is a crucial part of case-code-review. We welcome improvements to README files, inline code comments, configuration examples, and any user-facing text.
...
1. If you spot an issue but don't plan to fix it yourself, open a [Documentation Issue](https://github.com/qiankunli/case-code-review/issues/new?template=docs_report.yml).
...
1. case-code-review version (`ccr version`)
...
We require all contributors to sign the Open Source Contributor License Agreement before we can merge your contributions. This ensures that the project can be distributed under its license terms.
...
- [`good first issue`](https://github.com/qiankunli/case-code-review/labels/good%20first%20issue) — Small, well-scoped tasks ideal for getting started.
- [`help wanted`](https://github.com/qiankunli/case-code-review/labels/help%20wanted) — Issues where we'd appreciate community help.
...
- **Bug Reports** — [GitHub Issues](https://github.com/qiankunli/case-code-review/issues)
- **Feature Suggestions** — [GitHub Discussions (Ideas)](https://github.com/qiankunli/case-code-review/discussions/categories/ideas) or [Feature Request Issue](https://github.com/qiankunli/case-code-review/issues/new?template=feature_request.yml)
- **Questions & Help** — If you have any questions about using case-code-review, feel free to ask in [GitHub Discussions](https://github.com/qiankunli/case-code-review/discussions)

## License

By contributing to case-code-review, you agree that your contributions will be licensed under the [Apache License 2.0](LICENSE).
