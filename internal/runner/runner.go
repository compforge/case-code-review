...
type Args struct {
	...
	// Findings collects review comments generated by the code_comment tool.
...
func (a *Runner) dispatchUnits(ctx context.Context) ([]finding.Finding, error) {
	...
	comments := a.args.Findings.Comments()
...
func (a *Runner) executeReviewFilter(ctx context.Context, d change.Change) {
	...
	newPath := d.NewPath
	comments := a.args.Findings.CommentsForPath(newPath)
	if len(comments) == 0 {
		return
	}
