...
func TestFilterByPaths(t *testing.T) {
	all := []string{
		...
		"internal/runner/scan/provider.go",
		"README.md",
	}
	tests := []struct {
		name  string
		...
		{"dir prefix", []string{"internal/runner"}, []string{"internal/runner/runner.go", "internal/runner/fullscan.go", "internal/runner/scan/provider.go"}},
		{"multi", []string{"cmd/main.go", "internal/runner/scan"}, []string{"cmd/main.go", "internal/runner/scan/provider.go"}},
...
func TestNewProvider_NormalizesPaths(t *testing.T) {
	...
	want := []string{"internal/runner", "cmd", "internal/runner/source", "a/b"}
